...
const PeopleCard: React.FC<PeopleProps> = (person) => {
  ...
  return (
    <div
      ...
      className="transition-color -mx-4 flex cursor-pointer flex-row items-center gap-3 border-b-2 border-gray-100 px-4 py-5 duration-300 focus-within:bg-gray-50 hover:bg-gray-100"
    >
