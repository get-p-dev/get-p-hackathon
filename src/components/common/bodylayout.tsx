...
export function BodyLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <>
      <div className="navbar sticky border-b-2 bg-base-100">
        ...
        {token ? (
          ...
          <>
            <Link href="/auth/signup">
              <a>
                <span className="btn mr-2 px-2 font-semibold">회원가입</span>
              </a>
            </Link>
            <Link href="/auth/signin">
              <a>
                <span className="btn btn-ghost px-2 font-semibold">로그인</span>
              </a>
            </Link>
          </>
        )}
