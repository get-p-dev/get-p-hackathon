...
const ProjectCard: React.FC<ProjectProps> = ({
  ...
  return (
    <section
      className="transition-color -mx-4 flex cursor-pointer flex-col gap-1 border-b-2 border-gray-100 px-4 py-5 duration-300 focus-within:bg-gray-50 hover:bg-gray-100"
      key={_id}
      onClick={() => router.push(`/projects/${_id}`)}
    >
      <div className="flex-ro flex items-center justify-between gap-2">
